...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_82(
        _______,  QK_LOCK,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,              _______,            _______,
        _______,            _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,  _______,
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    if(oneshot_mods) {
        if (oneshot_mods & MOD_LALT) {
            RGB_MATRIX_INDICATOR_SET_COLOR(IK_F, 255, 255, 255);
        }

        if (oneshot_mods & MOD_LGUI) {
            RGB_MATRIX_INDICATOR_SET_COLOR(IK_D, 255, 255, 255);
        }
        if (oneshot_mods & MOD_LSFT) {
            RGB_MATRIX_INDICATOR_SET_COLOR(IK_S, 255, 255, 255);
        }
        if (oneshot_mods & MOD_LCTL) {
            RGB_MATRIX_INDICATOR_SET_COLOR(IK_A, 255, 255, 255);
        }
    }
    else {

        RGB_MATRIX_INDICATOR_SET_COLOR(IK_F, 0, 0, 0);
        RGB_MATRIX_INDICATOR_SET_COLOR(IK_D, 0, 0, 0);
        RGB_MATRIX_INDICATOR_SET_COLOR(IK_S, 0, 0, 0);
        RGB_MATRIX_INDICATOR_SET_COLOR(IK_A, 0, 0, 0);
    }
